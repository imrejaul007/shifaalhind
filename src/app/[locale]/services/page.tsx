...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return generateSEOMetadata({
    title_en: 'Medical Tourism Services - End-to-End Support | Shifa AlHind',
    title_ar: 'خدمات السياحة العلاجية - دعم شامل من البداية إلى النهاية | شفاء الهند',
    description_en: 'Complete medical tourism services: Free consultation, hospital selection, visa assistance, travel arrangements, 24/7 support. Native Arabic speakers who lived in GCC.',
    description_ar: 'خدمات سياحة علاجية شاملة: استشارة مجانية، اختيار المستشفى، مساعدة التأشيرة، ترتيبات السفر، دعم على مدار الساعة. متحدثون عرب أصليون عاشوا في دول الخليج.',
    locale,
    path: '/services',
  });
}

...
export default async function CervicalCancerTreatmentIndiaPage({ params }: { params: Promise<{ locale: string }> }) {
...
{/* Breadcrumb Schema for SEO */}
      ...
      <Testimonials
        ...
        title="Success Stories from Our Cervical Cancer Treatment Patients"
      ...
      <ContextualSidebar treatmentSlug="cervical-cancer-treatment-india" locale={locale as 'en' | 'ar'} />
      ...
      <TreatmentSchemas
        treatmentName="Cervical Cancer Treatment"
        lowPrice={5000}
        highPrice={15000}
        url="/en/treatments/cervical-cancer-treatment-india"
      />
    </div>
  );
}

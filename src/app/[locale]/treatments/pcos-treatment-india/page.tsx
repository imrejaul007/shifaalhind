...
export default async function PcosTreatmentIndiaPage({ params }: { params: Promise<{ locale: string }> }) {
...
{/* Breadcrumb Schema for SEO */}
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
              ...
              <Button asChild size="lg" className="border-2 border-green-400 bg-green-600 text-lg text-white hover:bg-green-700">
                <a href="https://wa.me/919876543210?text=Hi%2C%20I%20need%20help%20with%20PCOS%20Treatment%20in%20India" target="_blank" rel="noopener noreferrer">WhatsApp Us</a>
              </Button>
      ...
      <ContextualSidebar treatmentSlug="pcos-treatment-india" locale={locale as 'en' | 'ar'} />
      ...
      <TreatmentSchemas
        treatmentName="PCOS Treatment"
        lowPrice={1500}
        highPrice={4000}
        url="/en/treatments/pcos-treatment-india"
      />
    </div>
  );
}

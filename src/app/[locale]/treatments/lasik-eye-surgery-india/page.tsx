...
export default async function LasikEyeSurgeryIndiaPage({ params }: { params: Promise<{ locale: string }> }) {
...
{/* Breadcrumb Schema for SEO */}
      ...
      <ContextualSidebar treatmentSlug="lasik-eye-surgery-india" locale={locale as 'en' | 'ar'} />
      ...
      <TreatmentSchemas
        treatmentName="LASIK Eye Surgery"
        lowPrice={500}
        highPrice={1500}
        url="/en/treatments/lasik-eye-surgery-india"
      />
    </div>
  );
}

...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://shifaalhind.onrender.com/en/treatments/all-on-4-dental-implants-india',
    languages: {
      'en-US': 'https://shifaalhind.onrender.com/en/treatments/all-on-4-dental-implants-india',
      'ar-SA': 'https://shifaalhind.onrender.com/ar/treatments/all-on-4-dental-implants-india',
      'x-default': 'https://shifaalhind.onrender.com/en/treatments/all-on-4-dental-implants-india',
    },
  },
};
...
export default async function AllOn4DentalImplantsIndiaPage({ params }: { params: Promise<{ locale: string }> }) {
...
{/* Breadcrumb Schema for SEO */}
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
              ...
              <Button asChild size="lg" className="border-2 border-green-400 bg-green-600 text-lg text-white hover:bg-green-700">
                <a href="https://wa.me/919876543210?text=Hi%2C%20I%20need%20help%20with%20All-on-4%20Dental%20Implants%20in%20India" target="_blank" rel="noopener noreferrer">WhatsApp Us</a>
              </Button>
      ...
      <ContextualSidebar treatmentSlug="all-on-4-dental-implants-india" locale={locale as 'en' | 'ar'} />
      ...
      <TreatmentSchemas
        treatmentName="All-on-4 Dental Implants"
        lowPrice={4000}
        highPrice={7000}
        url="/en/treatments/all-on-4-dental-implants-india"
      />
    </div>
  );
}

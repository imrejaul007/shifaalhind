...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://shifaalhind.onrender.com/en/treatments/breast-cancer-treatment-india',
    languages: {
      'en-US': 'https://shifaalhind.onrender.com/en/treatments/breast-cancer-treatment-india',
      'ar-SA': 'https://shifaalhind.onrender.com/ar/treatments/breast-cancer-treatment-india',
      'x-default': 'https://shifaalhind.onrender.com/en/treatments/breast-cancer-treatment-india',
    },
  },
};

export default async function BreastCancerTreatmentIndiaPage({ params }: { params: Promise<{ locale: string }> }) {
...
{/* Breadcrumb Schema for SEO */}
      ...
      <ContextualSidebar treatmentSlug="breast-cancer-treatment-india" locale={locale as 'en' | 'ar'} />
      ...
      <TreatmentSchemas
        treatmentName="Breast Cancer Treatment"
        lowPrice={5000}
        highPrice={15000}
        url="/en/treatments/breast-cancer-treatment-india"
      />
    </div>
  );
}

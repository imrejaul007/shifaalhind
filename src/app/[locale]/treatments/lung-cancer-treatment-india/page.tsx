...
export default async function LungCancerTreatmentIndiaPage({ params }: { params: Promise<{ locale: string }> }) {
...
{/* Breadcrumb Schema for SEO */}
      ...
      <ContextualSidebar treatmentSlug="lung-cancer-treatment-india" locale={locale as 'en' | 'ar'} />
      ...
      <TreatmentSchemas
        treatmentName="Lung Cancer Treatment"
        lowPrice={5000}
        highPrice={20000}
        url="/en/treatments/lung-cancer-treatment-india"
      />
    </div>
  );
}

...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return generateSEOMetadata({
    title_en: 'Medical Treatments in India | 30+ Specialties | Save 60-80%',
    title_ar: 'العلاجات الطبية في الهند | أكثر من 30 تخصص | وفر 60-80%',
    description_en: 'Browse 30+ world-class medical treatments in India. Save 60-80% on surgeries, IVF, dental, cosmetic, and cancer treatments with JCI-accredited hospitals and native Arabic coordinators.',
    description_ar: 'تصفح أكثر من 30 علاجًا طبيًا عالمي المستوى في الهند. وفر 60-80% على الجراحات، التلقيح الصناعي، الأسنان، التجميل، وعلاجات السرطان مع مستشفيات معتمدة من JCI ومنسقين ناطقين بالعربية.',
    locale,
    path: '/treatments',
  });
}
...
export default async function TreatmentsPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const content = {
    en: {
      hero: {
        badge: '30+ World-Class Treatments Available',
        title: 'Medical Treatments in India',
        subtitle: 'Save 60-80% on world-class medical treatments with JCI-accredited hospitals and native Arabic-speaking coordinators from GCC',
        stats: [
        ...
        buttons: {
          ...
          popularGcc: 'Popular for GCC Patients',
        },
      },
      testimonials: {
        badge: 'Patient Success Stories',
        title: 'Why GCC Patients Choose India',
        subtitle: 'Thousands of patients from UAE, Saudi Arabia, Qatar, and other GCC countries save significantly while receiving world-class treatment',
        items: [
          {
      ...
      popularGcc: {
        badge: 'Most Popular',
        title: 'Top Treatments for GCC Patients',
        subtitle: 'These treatments are most frequently chosen by patients from UAE, Saudi Arabia, Qatar, Oman, Kuwait, and Bahrain',
        labels: {
          popular: 'Popular',
          save: 'Save',
      ...
      browseAll: {
        title: 'Browse All Treatments by Specialty',
        subtitle: 'Explore our complete range of medical treatments organized by specialty',
        labels: {
          treatments: (count: number) => `${count} treatments`,
      ...
      database: {
        title: 'Additional Specialized Treatments',
        subtitle: 'More specialized treatments available through our hospital network',
        labels: {
          availableIn: (count: number) => `Available in ${count} cities`,
          viewDetails: 'View Details',
        },
      },
      cta: {
        title: "Can't Find Your Treatment?",
        subtitle: 'Our native Arabic-speaking medical coordinators (from Dubai & Riyadh) will help you find the right treatment and hospital. Available 24/7 on WhatsApp.',
        buttons: {
          consultation: 'Free Medical Consultation',
          call: 'Call Us Now',
    ...
    ar: {
      hero: {
        badge: 'أكثر من 30 علاج عالمي المستوى متاح',
        title: 'العلاجات الطبية في الهند',
        subtitle: 'وفر 60-80% على علاجات طبية عالمية المستوى مع مستشفيات معتمدة من JCI ومنسقين ناطقين بالعربية من دول الخليج',
        stats: [
          { icon: TrendingDown, label: 'توفير 60-80%', value: 'مقارنة بأمريكا/بريطانيا/الإمارات' },
          { icon: Users, label: '10,000+', value: 'مرضى من الخليج' },
          { icon: Award, label: '40+', value: 'مستشفى معتمد JCI' },
          { icon: Clock, label: '24/7', value: 'دعم بالعربية' },
        ],
        buttons: {
          consultation: 'استشارة طبية مجانية',
          popularGcc: 'الأكثر شعبية لمرضى الخليج',
        },
      },
      testimonials: {
        badge: 'قصص نجاح المرضى',
        title: 'لماذا يختار مرضى الخليج الهند',
        subtitle: 'آلاف المرضى من الإمارات والسعودية وقطر ودول الخليج الأخرى يوفرون بشكل كبير أثناء تلقي علاج عالمي المستوى',
        items: [
          {
            name: 'أحمد المنصوري',
            location: 'دبي، الإمارات',
            treatment: 'عملية تجميل الأنف',
            quote: 'وفرت 14,000 دولار على جراحة أنفي. المنسق العربي الذي عاش في دبي لمدة 10 سنوات جعل كل شيء سلسًا. كان المستشفى أكثر تقدمًا من العيادات الخاصة في الإمارات!',
            rating: 5,
          },
          {
            name: 'فاطمة الرشيد',
            ...
            quote: 'بعد 3 دورات فاشلة من التلقيح الصناعي في الرياض، نجحنا في محاولتنا الأولى في بنغالور. وفرنا 75% وأصبحنا أبوين أخيرًا. الفريق الناطق بالعربية فهم احتياجاتنا تمامًا.',
            rating: 5,
          },
          {
            name: 'محمد الثاني',
            ...
            quote: 'كلفتني عملية استبدال الركبتين 8,000 دولار مقابل 50,000 دولار في قطر. عدت إلى لعب التنس في 3 أشهر. رتب المنسق كل شيء بما في ذلك الطعام الحلال وغرف الصلاة.',
            rating: 5,
          },
        ],
      },
      popularGcc: {
        badge: 'الأكثر شعبية',
        title: 'أفضل العلاجات لمرضى الخليج',
        subtitle: 'هذه العلاجات هي الأكثر اختيارًا من قبل المرضى من الإمارات والسعودية وقطر وعمان والكويت والبحرين',
        labels: {
          popular: 'شائع',
          save: 'وفر',
      ...
      browseAll: {
        title: 'تصفح جميع العلاجات حسب التخصص',
        subtitle: 'استكشف مجموعتنا الكاملة من العلاجات الطبية منظمة حسب التخصص',
        labels: {
          treatments: (count: number) => `${count} علاج`,
      ...
      database: {
        title: 'علاجات متخصصة إضافية',
        subtitle: 'المزيد من العلاجات المتخصصة المتاحة من خلال شبكة مستشفياتنا',
        labels: {
          availableIn: (count: number) => `متاح في ${count} مدينة`,
          viewDetails: 'عرض التفاصيل',
        },
      },
      cta: {
        title: 'لا يمكنك العثور على علاجك؟',
        subtitle: 'سيساعدك منسقونا الطبيون الناطقون بالعربية (من دبي والرياض) في العثور على العلاج والمستشفى المناسبين. متاحون على مدار الساعة طوال أيام الأسبوع على واتساب.',
        buttons: {
          consultation: 'استشارة طبية مجانية',
          call: 'اتصل بنا الآن',
        ...
        <div className="container relative mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Button asChild size="lg" variant="secondary" className="shadow-xl">
              <Link href="/consultation">{t.hero.buttons.consultation}</Link>
            </Button>
                  ...
                  <Card key={treatment.slug} className="group border-2 border-green-100 bg-white transition-all hover:scale-105 hover:border-green-300 hover:shadow-2xl">
                    <CardHeader>
                      ...
                      <div className="mt-2 flex items-center gap-2 text-sm font-semibold text-green-700">
                        ...
                        {t.popularGcc.labels.save} {treatment.savings}
                      </div>
                    </CardHeader>
                    <CardContent>
                      ...
                      <Button asChild className="w-full">
                        <Link href={`/treatments/${treatment.slug}`}>
                          {t.popularGcc.labels.viewDetails}
                        </Link>
                      </Button>
                    </CardContent>
                  </Card>
          ...
          {Object.entries(treatmentsByCategory).map(([category, items]) => (
            <div key={category} className="mb-12">
              <h3 className="mb-6 flex items-center gap-2 text-2xl font-bold text-gray-900">
                ...
                {category}
                <span className="text-lg font-normal text-gray-500">({t.browseAll.labels.treatments(items.length)})</span>
              </h3>
                    ...
                    <Card key={treatment.slug} className="group border-2 transition-all hover:scale-105 hover:shadow-xl">
                      <CardHeader>
                        ...
                        <div className="mt-2 flex items-center gap-1 text-xs font-semibold text-green-700">
                          ...
                          {t.browseAll.labels.save} {treatment.savings}
                        </div>
                      </CardHeader>
                      <CardContent>
                        <Button asChild className="w-full" size="sm">
                          <Link href={`/treatments/${treatment.slug}`}>
                            {t.browseAll.labels.viewDetails}
                          </Link>
                        </Button>
                      </CardContent>
                    </Card>
            ...
            {treatments.map((treatment) => {
              ...
              return (
                <Card key={treatment.id} className="transition-shadow hover:shadow-lg">
                  ...
                  <CardContent>
                    <p className="mb-4 text-sm text-gray-600">
                      {t.database.labels.availableIn(treatment.cityTreatments.length)}
                    </p>

...
{/* Breadcrumb Schema for SEO */}
      <BreadcrumbSchema items={[
        ...
        { name: 'Gastric Bypass Surgery in India', url: 'https://shifaalhind.onrender.com/treatments/gastric-bypass-india' }
      ]} />
      ...
      <Testimonials
        ...
        title="Success Stories from Our Gastric Bypass Patients"

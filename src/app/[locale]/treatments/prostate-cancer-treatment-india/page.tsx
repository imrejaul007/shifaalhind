...
export default async function ProstateCancerTreatmentIndiaPage({ params }: { params: Promise<{ locale: string }> }) {
...
{/* Breadcrumb Schema for SEO */}
      <BreadcrumbSchema items={[
        ...
        { name: 'Prostate Cancer Treatment in India', url: 'https://shifaalhind.onrender.com/treatments/prostate-cancer-treatment-india' }
      ]} />
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
              ...
              <Button asChild size="lg" className="border-2 border-green-400 bg-green-600 text-lg text-white hover:bg-green-700">
                <a href="https://wa.me/919876543210?text=Hi%2C%20I%20need%20help%20with%20Prostate%20Cancer%20Treatment%20in%20India" target="_blank" rel="noopener noreferrer">WhatsApp Us</a>
              </Button>
      ...
      <ContextualSidebar treatmentSlug="prostate-cancer-treatment-india" locale={locale as 'en' | 'ar'} />
      ...
      <TreatmentSchemas
        treatmentName="Prostate Cancer Treatment"
        lowPrice={5000}
        highPrice={15000}
        url="/en/treatments/prostate-cancer-treatment-india"
      />
    </div>
  );
}
